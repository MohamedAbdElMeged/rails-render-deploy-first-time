...
- visit [URL](https://firsttimewebservice.onrender.com)


# My Approach
### Understand the requirements
- Extract classes (Ticket, Excavator)
- Define Relations between classes 


### Setup The Requirements
- Setup (RoR , Postgresql)

### Iniailize Models and Create Migrations

-Create `Ticket` Model

-Create `Excavator` Model





## Create Consume API endpoints
- create `consume` endopoint


## Create Index,Show Actions
...
```
curl -X POST https://firsttimewebservice.onrender.com/api/v1/consume -d '{
    {
    "ContactCenter": "UPCA",
