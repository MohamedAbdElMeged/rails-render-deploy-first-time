...
RSpec.describe 'Api::V1::ConsumerController', type: :request do
    describe 'POST /consume' do
        context "when sending valid data" do
            before do
                post '/api/v1/consume', params: {
                    "ContactCenter": "UPCA",
            ...
            it "should save Ticket and Excavator" do
                expect(Ticket.first.request_number).to eq("09252012-00001")
                expect(Excavator.first.company_name).to eq("John Doe CONSTRUCTION")
        ...
        context "when sending invalid data" do
            ...
            it "shouldn't save Ticket and Excavator" do
                expect(Ticket.first).to eq(nil)
                expect(Excavator.first).to eq(nil)
            end
        end
    end
end